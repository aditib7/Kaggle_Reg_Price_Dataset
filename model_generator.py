...
df=pd.read_csv('train (1).csv', delimiter = ',', index_col = 0)
...
# dropping the 'Alley' column because of null values or low correlation
...
# Feature Transformation - creating new features from existing features
...
# using different models for regression
...
# writing a function for blending the models
